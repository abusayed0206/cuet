            ...
            <Card className="bg-white text-black ">
              ...
              <CardContent className="p-4 border-t border-b">
                <p className="text-xl text-center">
                  I am a Civil Engineering student currently in my fourth year
                  at Chittagong University of Engineering and Technology (CUET).
                  My major is Structural Engineering, and I have a keen interest
                  in research related to water and the environment.
                </p>
              </CardContent>
