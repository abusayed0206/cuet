...
const LoginPage = () => {
  ...
  return (
    <section className="relative min-h-screen bg-[#0f172a] flex flex-col items-center justify-center p-4 text-white overflow-hidden">
      ...
      <div 
        className="absolute inset-0 bg-gradient-to-br from-violet-600/20 via-transparent to-cyan-600/20"
        style={{
      ...
      <div className={cn(
        ...
        <Button variant="outline" asChild>
          <Link href="/" className={cn("text-white hover:text-purple-300 transition-all duration-300 hover:scale-105 focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#0f172a]")}>
      ...
      <div className={cn(
        "relative z-10 mx-auto max-w-md w-full flex flex-col justify-center space-y-6 p-8 bg-white/95 backdrop-blur-xl rounded-xl shadow-[0_10px_45px_rgba(59,130,246,0.3)] transition-all duration-500 opacity-0 scale-95",
        ...
        <div className="flex flex-col space-y-3 text-center">
          ...
          <p className="text-sm text-gray-600">
            Sign in to access your profile and explore the CUET community
          </p>
        </div>
        ...
        <div className={cn(
          ...
          <Link href="/register">
            <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white transition-all duration-300 hover:shadow-lg hover:translate-y-[-2px] focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 h-11">
              Register
            </Button>
          </Link>
          
          <Link href="/reset-password">
            <Button variant="outline" className="w-full text-gray-700 border-gray-300 hover:bg-gray-50 transition-all duration-300 hover:shadow-sm focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 h-11">
              Forgot Password?
            </Button>
          </Link>
        </div>
