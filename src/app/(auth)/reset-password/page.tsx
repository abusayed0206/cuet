...
const ResetPasswordForm = dynamic(() => import("./reset-password-form"), {
  loading: () => (
    <div className="w-full flex justify-center animate-pulse">
      <div className="w-full h-[180px] bg-gradient-to-b from-gray-100 to-gray-200 rounded-md"></div>
    </div>
  ),
  ssr: false,
});
...
const ResetPasswordPage = () => {
  ...
  return (
    <section className="relative min-h-screen bg-[#0f172a] flex flex-col items-center justify-center p-4 text-white overflow-hidden">
      ...
      <div 
        className="absolute inset-0 bg-gradient-to-br from-teal-600/20 via-transparent to-purple-600/20"
        style={{
      ...
      <div className={cn(
        ...
        <Button variant="outline" asChild>
          <Link href="/login" className={cn("text-white hover:text-teal-300 transition-all duration-300 hover:scale-105 focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-[#0f172a]")}>
      ...
      <div className={cn(
        "relative z-10 mx-auto max-w-md w-full flex flex-col justify-center space-y-6 p-8 bg-white/95 backdrop-blur-xl rounded-xl shadow-[0_10px_45px_rgba(20,184,166,0.3)] transition-all duration-500 opacity-0 scale-95",
        ...
        <Suspense fallback={
          <div className="w-full h-[180px] flex items-center justify-center">
            <div className="w-8 h-8 border-4 border-t-teal-600 border-r-transparent border-b-transparent border-l-transparent rounded-full animate-spin"></div>
          </div>
        }>
          <ResetPasswordForm />
        </Suspense>
