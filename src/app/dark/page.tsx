...
export default function DarkQuotePage() {
  ...
  useEffect(() => {
    fetch("https://api.seriesquotes.10cyrilc.me/quote/?series=dark&count=1&all=false")
          ...
          <Card className="bg-white text-black">
            ...
            <CardTitle className="p-6">
              {quote ? (
                ...
                <p className="text-center">Fetching quote...</p>
              )}
            </CardTitle>
            {quote && (
